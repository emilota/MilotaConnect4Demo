...
namespace MilotaConnect4Demo
{
    public class UIMetrics // used to keep board UI metric info
    {
        ...
        {
            GameObject GO_AnchorUL = board.App.GameSceneMB.GOAnchorUL;
            GameObject GO_AnchorUR = board.App.GameSceneMB.GOAnchorUR;
            GameObject GO_AnchorLL = board.App.GameSceneMB.GOAnchorLL;
