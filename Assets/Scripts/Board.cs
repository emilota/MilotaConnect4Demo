...
namespace MilotaConnect4Demo
{
    public class Board // manage our whole game board
    {
        ...
        public const App DEFAULT_APP = null;
        ...
        {
            if (this.App.GameSceneMB.DebugHumanPlayerAlwaysStartsFirst)
            {
        ...
        public bool CreateGameObjects()
        {
            ...
            GameObject goBoardRoot = mApp.GameSceneMB.GOBoardRoot;

            GameObject prefabPlayer1Checker = mApp.GameSceneMB.PrefabPlayer1Checker;
            GameObject prefabPlayer2Checker = mApp.GameSceneMB.PrefabPlayer2Checker;
        ...
        public void UpdateCheckerSelectShowHide()
        {
            if (mCheckerSelectInfo.Showing)
            {
                ...
                mCheckerSelectInfo.GOPlayer1End.SetActive(Util.Blink(this.App.GameSceneMB.SelectCheckerBlinkMS));
            }
            else
            {
